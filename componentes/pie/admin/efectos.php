$(document).ready(function(){
	...
	$("#regpanel").adjustPanel(); //Run the adjustPanel function on #chatpanel
	...
	$(window).resize(function () {
		...
		$("#alertpanel").adjustPanel();
                $("#regpanel").adjustPanel();
	});

	//Click event on Chat Panel + Alert Panel
	$("#regpanel a:first, #alertpanel a:first, #userpanel a:first").click(function() { //If clicked on the first link of #chatpanel and #alertpanel...
